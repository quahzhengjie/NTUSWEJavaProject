...
public class ExpensesClaimServiceImpl implements ExpensesClaimService {
  ...
  // In ExpensesClaimServiceImpl
  @Override
  public List<ExpensesClaim> getExpensesByCreatedBy(int createdById) {
    return expensesClaimRepository.findByCreatedById(createdById);
  }
